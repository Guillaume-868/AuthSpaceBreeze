...
class TestTechnologiesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Space.Shared.index', [
            ...
            'fields' => [
                'fr' => ['starships_fr' => 'Nom du vaisseau', 'description_fr' => 'Description', 'subtitle_fr' => 'Sous-titre'],
                'en' => ['starships_en' => 'Name ', 'description_en' => 'Description', 'subtitle_en' => 'Subtitle'],
            ],
            'items' => $items,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('planets.index')->with('success', '✅ Technologie créée avec succès !');
    }
}
